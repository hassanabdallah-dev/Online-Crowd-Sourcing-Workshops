<!doctype html>
<html style='overflow:hidden;zoom:150%;' lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
<body class="banner-area" style='z-index:0; background-image:url({{ asset("images/bg1.jpg") }}); '>
    ...
    <nav class="navbar navbar-expand-md navbar-light shadow-sm">
        ...
        <main class="py-4 h-100">
            @yield('content')
            <div  class=" container h-100 align-self-center d-flex align-items-center justify-content-center" style="z-index:-1;">
        <div class="row d-flex justify-content-center">

        <h1 style="position:fixed;top:20%;" align="center">
        <span class="logo">WE<span>LCOME </span></span>
</h1>
</div>
</div>
